...
function myFunction2(){
			echo '<div class="tab">';
		            ...
		            echo '<br><a href="ApplicationView.php?f=true" id="linkMenu"> New Loan Requests&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ';echo	$_SESSION['NRcount'];
		            echo' 	</a><br><br><a href="ApplicationView.php?a=true" id="linkMenu">Not Complete Applications</a><br><br>
		             		<a href="ApplicationView.php?b=true" id="linkMenu"> Wait for Manager Approval</a><br><br>
		         		    <a href="ApplicationView.php?c=true" id="linkMenu">Approved Applications</a> <br><br>
		         	   		<a href="ApplicationView.php?d=true" id="linkMenu">Arrears</a><br><br>
		          		    <a href="ApplicationView.php?e=true" id="linkMenu"> Email Box</a><br><br>';
		          	echo '</form>';
 			echo '</div>';
...
<?php }elseif ($_SESSION['loanType']=='Business Loan'){ ?>
	...
	<div  class="tabcontent">
				            ...
				            if ($result2 =mysqli_query($conn, $query3)) {
			            			...
			            			if (mysqli_num_rows($result2) > 0) {
			            				...
			            				while ($row3 = mysqli_fetch_array($result2)) {
			            					...
			            					echo '<tr><td>Loan purpose: </td><td>';echo $row3['loanPurpose'];'</td></tr>';
						            			...
						            			if ($result3 =mysqli_query($conn, $query4)) {
							            			if (mysqli_num_rows($result3) > 0) {
							            				...
							            				while ($row4 = mysqli_fetch_array($result3)) {
							            					...
							            					echo '<tr><td>Loan amount: </td><td>';echo $row4['appliedLoanAmount'];'</td></tr>';
							            					echo '<tr><td>Payment method: </td><td>';echo $row4['appliedMethod'];'</td></tr>';
										                ...
										                {  
										                     echo '  
										                          <tr> 
										                          	<td>NIC copy</td> 
										                               <td>  
										                                    <img src="data:image/jpeg;base64,'.base64_encode($row5['NIC'] ).'" height="200" width="200" class="img-thumnail" />  
										                               </td>  
										                          </tr>  
										                     ';  
										                }  
 	...
 	echo '<br><br><form action="form.php" id="f1" method="post"><a href="work.php?wait=true" id="link3">NotComplete</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" form="f1" value="mapr" name="workbtn2" onclick="return confirm ("Are You sure to accept this application?");">Send to manager approval</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="work3.php" id="link3" style="background-color:red;">Reject</a></form><br><br>';
 		
 	}
 	function new3(){
 		
 	echo '<br><br><form action="uploadImage.php" id="f1" method="post"><button type="submit" form="f1" value="mapr" name="workbtn2" ">Go to application</button></form><br><br>';
 		
 	}
	function new4(){
 		
 	echo '<br><br><form action="applicationFill.php" id="f1" method="post"><button type="submit" form="f1" value="mapr" name="workbtn2" ">Issue loan</button></form><br><br>';
...
<?php }elseif ($_SESSION['loanType']!='Business Loan'){ ?>
	...
	<div class="tabcontent">
 	...
 	echo '<br><br><form action="form.php" id="f1" method="post"><a href="work.php?wait=true" id="link3">NotComplete</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" form="f1" value="mapr" name="workbtn2" onclick="return confirm ("Are You sure to accept this application?");">Send to manager approval</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="work3.php" id="link3">Reject</a></form><br><br>';
...
<?php 
	function myFunction(){
		...
		echo '<div  class="tabcontent">';
			//echo "Not Complete Applications";
			require_once('connection.php');
			        ...
			        if ($res10 =mysqli_query($conn, $query10)) {
			            if (mysqli_num_rows($res10) > 0) { 
			              while ($row = mysqli_fetch_array($res10)) {   
			              	$type=$row['loanType'];
			              	$_SESSION['loanType']=$type;
			                $query11="select* from customer where loanType='$type' && loanStatus='W' ";
			                    if ($result2 =mysqli_query($conn, $query11)) {	
			            			if (mysqli_num_rows($result2) > 0) {
			            				//echo '<div id="NLR" class="tabcontent">';
			            				while ($row3 = mysqli_fetch_array($result2)) {
			            			...
			            			//echo '</div>';
			            				...
			            				echo "There are no any applications";
			            			}
			            		}
			              }
			            }else{  echo $conn->error; }
			        ...
			        if ($res10 =mysqli_query($conn, $query10)) {
			            if (mysqli_num_rows($res10) > 0) { 
			              while ($row = mysqli_fetch_array($res10)) {   
			              	$type=$row['loanType'];
			              	$_SESSION['loanType']=$type;
			                $query11="select* from customer where loanType='$type' && loanStatus='OAPR' ";
			                    if ($result2 =mysqli_query($conn, $query11)) {	
			            			if (mysqli_num_rows($result2) > 0) {
			            				//echo '<div id="NLR" class="tabcontent">';
			            				while ($row3 = mysqli_fetch_array($result2)) {
