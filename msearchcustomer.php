...
//$remainingNoOfInstallments=$row['remainingNoOfInstallments'];
              ...
              $query3="SELECT* FROM customerareasedetails WHERE customerId='$customerId'";
    $result3=$conn->query($query3);
    $row=$result3->fetch_assoc();

    if($result3->num_rows > 0){
             //$arrearseId=$row['arrearseId'];
             //$arrearseStatus = $row['arrearseStatus'];
             $installmentPaidDate=$row['installmentPaidDate'];
...
<body>
    ...
    <tr><td colspan="2"><h4 style="text-align: center;">Loan Details</h4></td></tr>       
      ...
      <tr><td colspan="2"><h4 style="text-align: center;">Arrearse Details</h4></td></tr>
          
                         

                              <tr>
                                <td>Installment Paid Date</td>
                                <td><?php echo $installmentPaidDate; ?></td>
                              </tr>                               </tbody>
                  </table>
